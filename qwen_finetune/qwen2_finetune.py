...
def train(model_args,data_args,training_args,lora_args):
    #model_args,data_args,data_args,lora_args
    global local_rank
...
if __name__ == "__main__":
    ...
    model_args.model_name_or_path = 'G:/WorkSpace/aigc/llm_models_store/llm_chat_models/qwen2_0.5b_instruct'

    data_args.data_path='data/self_cognition/new_train.json'
    data_args.eval_data_path='data/self_cognition/new_dev.json'
    data_args.lazy_preprocess=True

    training_args.model_max_length=80
    training_args.use_lora=True
    # TrainingArguments.output_dir='output'
    # TrainingArguments.use_cpu=False
    training_args.num_train_epochs=600
    ...
    '''
    python finetune.py --model_name_or_path G:/WorkSpace/aigc/llm_models_store/llm_chat_models/qwen2_0.5b_instruct --data_path example_data.jsonl --eval_data_path example_data.jsonl --output_dir output --use_lora True --use_cpu False --model_max_length 64 --num_train_epochs 10 --bf16 True --per_device_train_batch_size 2 --per_device_eval_batch_size 1 --gradient_accumulation_steps 8 --save_strategy "steps" --save_steps 3 --save_total_limit 10 --learning_rate 3e-4 --weight_decay 0.01
    python finetune.py 
    --model_name_or_path G:/WorkSpace/aigc/llm_models_store/llm_chat_models/qwen2_0.5b_instruct 
    --data_path example_data.jsonl 
    --eval_data_path example_data.jsonl 
    --output_dir output 
    --use_lora True 
    --use_cpu False 
    --model_max_length 64 
